...
internal partial interface IPolygonApiRefit
{
	...
	Task<PolygonResponse<OptionsContractDetail>> GetOptionsContractDetail(string ticker, [Query, AliasAs("as_of")] DateOnly? date = null, CancellationToken cancellationToken = default);
